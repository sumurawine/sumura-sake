...
/** すべてのページに共通で付ける言い回し */
const SUFFIX = '｜すむら酒店・洲村酒店（山口県宇部市のワイン専門店）';
...
export const PAGES: Page[] = [
  {
    path: '/home',
    title: 'フランス銘醸ワインの専門店',
    desc: 'すむら酒店（洲村酒店／Liquor Shop Sumura）は山口県宇部市のワイン専門店です。ブルゴーニュを中心にボルドー、ローヌ、ジュラ、ロワールの銘醸ワインを正規ルートで取り揃えております。DRC、ルロワ、ドーヴネの正規取り扱いもございます。',
  },
  {
    path: '/producers',
  ...
  {
    path: '/virtual',
    title: 'バーチャル店舗｜店内を歩いて選ぶ',
    desc: 'すむら酒店（洲村酒店）の店内を、そのまま歩いていただけるバーチャル店舗でございます。棚の一本を手に取り、店員にお声がけいただけます。山口県宇部市中村3-6-20、10:00〜18:30、火曜定休。',
  },
  {
    path: '/mukashi',
    title: '昔のすむら酒店',
