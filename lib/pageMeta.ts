...
export const PAGE_I18N: Record<string, Partial<Record<Lang, { t: string; d: string }>>> = {
  '/home': {
    en: { t: 'Sumura Sake Shop (すむら酒店) — fine French wines from Ube, Japan', d: 'Liquor Shop Sumura — すむら酒店, in kanji 洲村酒店 — is a wine merchant in Ube, Yamaguchi, Japan. Burgundy above all, with Bordeaux, the Rhône, Jura, the Loire and Alsace, sourced through official channels. An authorised stockist of Domaine de la Romanée-Conti, Domaine Leroy and Domaine d’Auvenay.' },
    fr: { t: 'Sumura (すむら酒店) — grands vins de France, depuis Ube au Japon', d: 'Liquor Shop Sumura — すむら酒店, en kanji 洲村酒店 — est un caviste à Ube, Yamaguchi, au Japon. La Bourgogne avant tout, mais aussi Bordeaux, le Rhône, le Jura, la Loire et l’Alsace, en filière officielle. Dépositaire agréé de la Romanée-Conti, du Domaine Leroy et du Domaine d’Auvenay.' },
